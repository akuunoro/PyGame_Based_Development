...
Okay, I've decided to refractor and change the entire folder structure of my repository. Mainly due to me wanting to separate the directories for just pure studying the concepts and logic - being the [Playgroung](playground/) directory, and a directory for projects (that will mostly contains mini games, but probably some major games) to apply those concepts and logic I've studied on a real game. 
...
Today, I will start exploring how movement and sprite animation works in PyGame. 
